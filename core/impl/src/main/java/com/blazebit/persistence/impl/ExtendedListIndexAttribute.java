 ...
 * @since 1.3.0
 */
public class ExtendedListIndexAttribute<X> extends ListIndexAttribute<X> implements ExtendedAttribute<X, Integer> {

    private final ExtendedAttribute listAttribute;

    public ExtendedListIndexAttribute(ExtendedAttribute listAttribute) {
        super((ListAttribute<?, ?>) listAttribute.getAttribute());
