 ...
 * @since 1.3.0
 */
public class ExtendedMapEntryAttribute<X> extends MapEntryAttribute<X> implements ExtendedAttribute<X, Map.Entry<?, ?>> {

    private final ExtendedAttribute mapAttribute;

    public ExtendedMapEntryAttribute(ExtendedAttribute mapAttribute) {
        super((MapAttribute<?, ?, ?>) mapAttribute.getAttribute());
    ...
    @Override
    public Class<Map.Entry<?, ?>> getElementClass() {
