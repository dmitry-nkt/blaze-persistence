...
package com.blazebit.persistence.view.materialization.elasticsearch.model;
...
@Materialization(schema = "es", name = "documentsimpleview_mat")
public interface DocumentSimpleView {
